...
var app = (function () {
    ...
    function instance($$self, $$props) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Bulma> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("Bulma", $$slots, []);
    	return [];
    }

    class Bulma extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		o: function outro(local) {
    			transition_out(bulma.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
